  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-7">
      ...
      <Card className="p-5 flex flex-col sm:flex-row items-center gap-4">
        {/* Sunken Neumorphic Search input */}
      ...
      {filteredMatches.length > 0 ? (
        ...
        <Card className="p-12 text-center space-y-3">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-2xl bg-[#EEF2F6] shadow-neu-sm hover:shadow-neu-flat text-xs font-bold text-slate-700 transition-all"
          >
            Reset Filters
          </button>
        </Card>
