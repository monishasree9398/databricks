...
export const Header: React.FC = () => {
  ...
  return (
    <header
      className={`sticky top-0 z-20 h-16 bg-[#EEF2F6]/90 backdrop-blur-md px-4 sm:px-6 flex items-center justify-between transition-all duration-300 ${
        isSidebarCollapsed ? 'md:ml-20' : 'md:ml-64'
      }`}
    >
      {/* Left: Active Status Badge OR Selector */}
      <div className="flex items-center gap-3">
        {mode === 'student' ? (
          <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-2xl bg-[#EEF2F6] shadow-neu-sm">
            ...
            <span className="text-[10px] text-brand-orange font-mono font-bold px-1.5 py-0.5 rounded-lg shadow-neu-pressed shrink-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative flex items-center">
              <select
                ...
                className="appearance-none bg-[#EEF2F6] shadow-neu-pressed rounded-xl pl-3 pr-8 py-1.5 text-xs font-bold text-slate-800 focus:outline-none cursor-pointer transition-all max-w-[200px] sm:max-w-[280px] truncate"
              >
                {studentsList.map(st => (
                  <option key={st.id} value={st.id} className="bg-[#EEF2F6] text-slate-900 py-1">
      ...
      <div className="flex items-center gap-3.5">
        {/* Experience Mode Toggle Switch */}
        <div className="flex items-center p-1 rounded-2xl bg-[#EEF2F6] shadow-neu-pressed">
          <button
        ...
        <div className="relative" ref={profileMenuRef}>
          <button
            ...
            className="flex items-center gap-2 p-1.5 rounded-2xl bg-[#EEF2F6] shadow-neu-sm hover:shadow-neu-flat transition-all"
          >
            <img
              ...
              alt="Avatar"
              className="w-6 h-6 rounded-xl object-cover shadow-neu-sm"
            />
          ...
          {isProfileOpen && (
            <div className="absolute right-0 mt-3 w-56 rounded-3xl bg-[#EEF2F6] shadow-neu-lg p-3 z-50 space-y-1.5">
              <div className="px-3 py-2 rounded-2xl shadow-neu-pressed mb-2">
                ...
                <span className="inline-block mt-1 text-[10px] font-bold text-brand-orange uppercase font-mono">
              ...
              <button
                ...
                className="w-full flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-bold text-slate-700 hover:shadow-neu-sm transition-all"
              >
              ...
              <button
                ...
                className="w-full flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-bold text-rose-600 hover:shadow-neu-sm transition-all"
              >
      ...
      {/* 1. FACULTY ID AUTHENTICATION MODAL */}
      <Modal
      ...
      >
        <form onSubmit={handleVerifyFacultyId} className="space-y-4">
          <div className="p-4 rounded-2xl bg-[#EEF2F6] shadow-neu-pressed flex items-start gap-3">
            <div className="p-2 rounded-xl bg-[#EEF2F6] shadow-neu-sm text-brand-orange shrink-0">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full bg-[#EEF2F6] shadow-neu-pressed rounded-xl pl-9 pr-3 py-2.5 text-xs font-medium text-slate-900 focus:outline-none transition-all"
              />
            </div>
          </div>
          ...
          <div className="pt-2 flex items-center justify-end gap-3">
            ...
            <button
              type="submit"
              className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-xl bg-brand-orange text-white font-bold text-xs shadow-neu-orange transition-all"
            >
      ...
      {/* 2. STUDENT ID AUTHENTICATION MODAL */}
      <Modal
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <select
                ...
                className="w-full bg-[#EEF2F6] shadow-neu-pressed rounded-xl px-3.5 py-2.5 text-xs font-bold text-slate-900 focus:outline-none transition-all"
              >
                {studentsList.map(st => (
