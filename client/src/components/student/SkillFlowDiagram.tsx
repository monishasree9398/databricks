  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 items-stretch">
        ...
        <Card className="p-5 flex flex-col justify-between border-emerald-200">
          <div>
            ...
            <div className="space-y-3">
              {haveSkills.map(s => (
                ...
                >
                  <div>
                    <span className="text-xs font-bold text-slate-800 block line-clamp-1">{s.skillName}</span>
          ...
          <div className="mt-4 pt-3 border-t border-slate-100 text-[11px] text-slate-400 font-medium">
            Exceeds minimum recruiter threshold for {targetRole}
          </div>
        </Card>

        {/* Column 2: Active Skill Gaps */}
        <Card className="p-5 flex flex-col justify-between border-orange-200 bg-orange-50/20" glow>
          <div>
            <div className="flex items-center justify-between pb-3 mb-4 border-b border-orange-100">
              <div className="flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-brand-orange" />
                <h4 className="text-sm font-bold text-brand-orange tracking-tight uppercase">
                  Active Skill Gaps
                </h4>
              </div>
              <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-orange-100 text-brand-orange font-mono">
            ...
            <div className="space-y-3">
              {[...improveSkills, ...learnSkills].map(s => (
                <div
                  key={s.skillName}
                  className="p-3 rounded-xl bg-white border border-orange-200 space-y-1.5 shadow-sm"
                >
          ...
          <div className="mt-4 pt-3 border-t border-orange-100 flex items-center justify-between text-[11px] text-brand-orange font-mono">
        ...
        <Card className="p-5 flex flex-col justify-between">
          <div>
            ...
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2.5">
              ...
              <h5 className="text-base font-bold text-slate-900 font-sans">
                {targetRole}
              </h5>
              ...
              <div className="pt-2 border-t border-slate-200 space-y-1.5 text-xs text-slate-600 font-mono">
                <div className="flex items-center justify-between">
